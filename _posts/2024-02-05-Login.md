      ...
      fetch("http://localhost:8086/api/users/authenticate", requestOptions)
          .then(response => {
            if (response.ok) {
                ...
                window.location.href = "http://127.0.0.1:4200/student/2023/11/07/Flashcards.html"
              } else {
...
<p><label for="uid">User ID:</label>
    ...
    <p>
     <button class="button-spacing">Log In</button>
          <button onClick = "window.location.href ='http://127.0.0.1:4200/student/2024/02/05/Signup.html'" class="button-spacing" >Sign Up</button>
    </p>